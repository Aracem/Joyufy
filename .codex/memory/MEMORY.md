# Joyufy — Codex Project Memory

Read the matching `.claude/memory/` files for full project context. Codex keeps concise mirrors here for durable notes added during Codex sessions.
